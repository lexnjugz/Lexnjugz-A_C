...
class Dashboard extends Admin_Controller {
    ...
    public function index($action = NULL) {
        ...
        $data['total_aincome'] = $total_income;
        
        $data['total_aexpense'] = $total_expense;
    ...
    public function get_income_expense($month) {// this function is to create get monthy recap report 
