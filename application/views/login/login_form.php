...
<div class="login-box">    
    ...
    <div class="login-box-body">
        ...
        <form role="form" action="<?php echo base_url() ?>login" method="post">
            ...
            <div class="row">
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat"><?= lang('sign_in') ?></button>
                </div><!-- /.col -->                        
                <div class="col-xs-8">
                    <label class="btn pull-right"><a href="<?= base_url() ?>login/forgot_password"><?= lang('forgot_password') ?></a></label>
                </div><!-- /.col -->
            </div>            
        </form>
        <br/>
