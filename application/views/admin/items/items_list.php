...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content no-padding">
                    ...
                    <tbody>
                        ...
                        foreach ($all_items as $v_items):
                            ...
                            <tr>
                                ...
                                <td><?= $currency->symbol . ' ' . number_format($v_items->unit_cost, 2); ?></td>     
                                <td>
        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
            <form role="form" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/items/saved_items/<?php
            if (!empty($items_info)) {
            ...
            ?>" method="post" class="form-horizontal  ">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= lang('unit_price') ?> <span class="text-danger">*</span></label>
                    <div class="col-lg-5">
