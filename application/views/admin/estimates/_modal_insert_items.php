<div class="panel panel-default">
    ...
    <div class="modal-body wrap-modal wrap">
        ...
        <form role="form" id="from_items" action="<?php echo base_url(); ?>admin/estimates/add_insert_items/<?= $invoices_id ?>" method="post" class="form-horizontal form-groups-bordered">
                    ...
                    <tbody>
                        ...
                        if (!empty($invoice_items)) :
                            foreach ($invoice_items as $v_item) :
                                ?>
                                <tr>
                                    <td><input class="child_present" type="checkbox" name="saved_items_id[]" value="<?php echo $v_item->saved_items_id; ?>"/></td>                                    
