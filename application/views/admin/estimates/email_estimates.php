                                ...
                                foreach ($all_estimates_info as $key => $v_estimate) {
                                    ...
                                    ?>"><a href="<?= base_url() ?>admin/estimates/index/estimates_details/<?= $v_estimate->estimates_id ?>">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <?= $currency->symbol ?> <?= number_format($this->estimates_model->estimate_calculation('estimate_amount', $estimates_info->estimates_id), 2) ?>
                                            </div> <br>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="<?= base_url() ?>admin/estimates/send_estimates_email/<?= $estimates_info->estimates_id ?>">
                    ...
                    <input type="hidden" name="amount" value="<?= number_format($this->estimates_model->estimate_calculation('estimate_amount', $estimates_info->estimates_id), 2) ?>">
