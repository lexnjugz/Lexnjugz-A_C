        ...
        <div class="box box-solid">
            ...
            <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="<?php echo ($menu_active == 'draft') ? 'active' : ''; ?>"><a href="<?= base_url() ?>admin/mailbox/index/draft"><i class="fa fa-file-text-o"></i> Drafts</a></li>
                    <li class="<?php echo ($menu_active == 'favourites') ? 'active' : ''; ?>">
                        <a href="<?= base_url() ?>admin/mailbox/index/favourites"> <i class="fa fa-star text-yellow"></i>
                            <?= lang('favourites') ?>
                        </a>
                    </li>
