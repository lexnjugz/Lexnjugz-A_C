                            ...
                            <tbody style="font-size: 13px">
                                <?php if (!empty($draft_message)):foreach ($draft_message as $v_draft_msg): ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url() ?>admin/mailbox/index/read_draft_mail/<?php echo $v_draft_msg->draft_id ?>"><?php
                                            ...
                                            <td><a class="btn btn-primary btn-xs" href="<?php echo base_url() ?>admin/mailbox/restore/draft/<?php echo $v_draft_msg->draft_id ?>" data-toggle="tooltip" data-placement="top"  title="Restore"><i class="fa fa-retweet"></i></a>                                                
                                                <a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/mailbox/delete_mail/draft/deleted/<?php echo $v_draft_msg->draft_id ?>" onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" data-toggle="tooltip" data-placement="top"  title="Permanent&nbsp;Delete"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>                  
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
