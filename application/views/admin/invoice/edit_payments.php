            ...
            <div class="panel-body">
                ...
                ?>" class="form-horizontal">                    
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" required="" class="form-control" value="<?= $payments_info->amount ?>" name="amount">
                        </div>
                    </div>
                            ...
                            <select name="payment_method" required="" class="form-control">
                                ...
                                if (!empty($payment_methods)) {
                                    foreach ($payment_methods as $p_method) {
                                        ?>
                                        <option value="<?= $p_method->payment_methods_id ?>"<?= ($payments_info->payment_method == $p_method->payment_methods_id ? ' selected="selected"' : '') ?>><?= $p_method->method_name ?></option>
                                        <?php
                                    }
                                }
                                ?>					
