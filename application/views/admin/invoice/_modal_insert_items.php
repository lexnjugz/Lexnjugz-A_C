<div class="panel panel-default">
    ...
    <div class="modal-body wrap-modal wrap">
        ...
        <form role="form" id="from_items" action="<?php echo base_url(); ?>admin/invoice/add_insert_items/<?= $invoices_id ?>" method="post" class="form-horizontal form-groups-bordered">
