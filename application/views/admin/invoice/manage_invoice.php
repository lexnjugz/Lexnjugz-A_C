                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                ?>>
                                    ...
                                    <option value="7D"<?= ($invoice_info->recur_frequency == "7D" ? ' selected="selected"' : '') ?>><?= lang('week') ?></option>
                                    <option value="1M"<?= ($invoice_info->recur_frequency == "1M" ? ' selected="selected"' : '') ?>><?= lang('month') ?></option>
                                    <option value="3M"<?= ($invoice_info->recur_frequency == "3M" ? ' selected="selected"' : '') ?>><?= lang('quarter') ?></option>
                                    <option value="6M"<?= ($invoice_info->recur_frequency == "6M" ? ' selected="selected"' : '') ?>><?= lang('six_months') ?></option>
                                    <option value="1Y"<?= ($invoice_info->recur_frequency == "1Y" ? ' selected="selected"' : '') ?>><?= lang('1year') ?></option>
                                    <option value="2Y"<?= ($invoice_info->recur_frequency == "2Y" ? ' selected="selected"' : '') ?>><?= lang('2year') ?></option>
                                    <option value="3Y"<?= ($invoice_info->recur_frequency == "3Y" ? ' selected="selected"' : '') ?>><?= lang('3year') ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
