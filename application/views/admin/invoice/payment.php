...
<div class="row">    
    <div class="col-sm-3">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                if ($role == '1') {
                    ?>
                    <a style="margin-top: -5px;" href="<?= base_url() ?>admin/invoice/manage_invoice/create_invoice" data-original-title="<?= lang('new_invoice') ?>" data-toggle="tooltip" data-placement="top" class="btn btn-icon btn-<?= config_item('button_color') ?> btn-sm pull-right"><i class="fa fa-plus"></i></a>
                <?php } ?>
                <?= lang('all_invoices') ?>
            </div>
                                    ...
                                    ?>">
                                        ...
                                        <a href="<?= base_url() ?>admin/invoice/manage_invoice/invoice_details/<?= $v_invoices->invoices_id ?>">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <?= $currency->symbol ?>  <?= number_format($this->invoice_model->get_invoice_cost($v_invoices->invoices_id), 2) ?>
                                            </div> <br>
    ...
    <section class="col-sm-9">     
        ...
        <section class="panel panel-default" >
            ...
            <div class="panel-body">
                <form method="post" action="<?= base_url() ?>admin/invoice/get_payemnt/<?= $invoice_info->invoices_id ?>" class="form-horizontal">
                    <?php $currency = $this->invoice_model->client_currency_sambol($v_invoices->client_id); ?>                                                                        
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-lg-3 control-label"><?= lang('amount') ?> (<?= $currency->symbol ?>) <span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            ...
                            <select name="payment_method" required="" class="form-control">
                                ...
                                if (!empty($payment_methods)) {
                                    foreach ($payment_methods as $p_method) {
                                        ?>
                                        <option value="<?= $p_method->payment_methods_id ?>"><?= $p_method->method_name ?></option>
                                        <?php
                                    }
                                }
                                ?>					
