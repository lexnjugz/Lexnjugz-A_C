                        ...
                        if (!empty($all_tickets_info)) {
                            foreach ($all_tickets_info as $v_tickets_info) {
                                ...
                                <tr>
                                    ...
                                    <td><a class="text-info" href="<?= base_url() ?>admin/tickets/index/tickets_details/<?= $v_tickets_info->tickets_id ?>"><?= $v_tickets_info->subject ?></a></td>
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                if (!empty($status_info)) {
                                                    foreach ($status_info as $v_status) {
                                                        ?>
                                                        <li><a data-toggle='modal' data-target='#myModal' href="<?= base_url() ?>admin/tickets/change_status/<?= $v_tickets_info->tickets_id ?>/<?= $v_status->status ?>"><?= ucfirst($v_status->status) ?></a></li>
                                                        <?php
                                                    }
                                                }
                                                ?>
