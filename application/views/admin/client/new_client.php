...
<div class="row">    
            ...
            <div class="panel-body">
                <div class="scrollable">
                    <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                        <ul class="nav" >
                            <?php if (!empty($all_client_info)):foreach ($all_client_info as $v_client_info): ?>
                                    <li class="" >
                                        <a href="<?= base_url() ?>admin/client/client_details/<?= $v_client_info->client_id ?>" data-toggle="tooltip" data-original-title="<?php
                                        if ($v_client_info->client_status == 1) {
                                            echo 'Person';
                                        } else {
                                            echo 'Company';
                                        }
                                        ?>">
                                               <?php echo $v_client_info->name ?>
                                            <p><small style="font-size: 11px">
                                                    <?php
                                                    if ($v_client_info->primary_contact != 0) {
                                                        $contacts = $v_client_info->primary_contact;
                                                    } else {
                                                        $contacts = NULL;
                                                    }
                                                ...
                                                <small class="pull-right text-muted label label-success">                                               
                                                    <strong>
                                                        <?= $this->client_model->count_rows('tbl_account_details', array('company' => $v_client_info->client_id)) ?>
                                                    </strong>                                                
                                                </small>
                                            </p>
    ...
    <div class="col-sm-9">   
        <form role="form" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/client/save_client/<?php
        if (!empty($client_info)) {
            echo $client_info->client_id;
        }
        ?>" method="post" class="form-horizontal  ">
            <section class="panel panel-default">
                <header class="panel-heading  "><?= lang('new_client') ?></header>
                <div class="panel-body">                    
