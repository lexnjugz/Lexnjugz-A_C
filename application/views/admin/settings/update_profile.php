    ...
    <div class="col-sm-6 wrap-fpanel">
        <div class="panel panel-default" data-collapsed="0">
            ...
            <div class="panel-body">
                <form role="form" id="update_profile" enctype="multipart/form-data" style="display: initial" action="<?php echo base_url(); ?>admin/settings/profile_updated" method="post" class="form-horizontal form-groups-bordered">                        
                ...
                <form role="form" id="change_password" style="display: initial" action="<?php echo base_url(); ?>admin/settings/change_email" method="post" class="form-horizontal form-groups-bordered">                        
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><strong><?= lang('password') ?></strong></label>
                        <div class="col-lg-8">
                            <input type="password" class="form-control" name="password" placeholder="<?= lang('password_current_password') ?>" onchange="check_current_password(this.value)" required>
    ...
    <div class="col-sm-6 wrap-fpanel">
        <div class="panel panel-default" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" id="change_password" style="display: initial" action="<?php echo base_url(); ?>admin/settings/change_username" method="post" class="form-horizontal form-groups-bordered">                        
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><strong><?= lang('password') ?></strong></label>
                        <div class="col-lg-8">
                            <input type="password" class="form-control" name="password" placeholder="<?= lang('password_current_password') ?>" onchange="check_current_password(this.value)" required>
