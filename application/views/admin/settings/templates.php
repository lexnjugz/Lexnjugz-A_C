...
switch ($template_group) {
    case "extra": $default = "estimate_email";
        break;
    case "invoice": $default = "invoice_message";
        break;
    case "tasks": $default = "task_assigned";
        break;
    case "bugs": $default = "bug_assigned";
        break;
    case "project": $default = "client_notification";
        break;
...
$email['extra'] = array("estimate_email", "message_received", "quotations_form");
        ...
        <div class="col-lg-12">
            <div class="btn-group" style="margin-bottom: 10px;">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?= base_url() ?>admin/settings/templates/invoice"><?= lang('invoicing_emails') ?></a></li>                    
                    ...
                    <li><a href="<?= base_url() ?>admin/settings/templates/project"><?= lang('project_emails') ?></a></li>                    
                    <li><a href="<?= base_url() ?>admin/settings/templates/ticket"><?= lang('ticketing_emails') ?></a></li>
                    <li class="divider"></li>
