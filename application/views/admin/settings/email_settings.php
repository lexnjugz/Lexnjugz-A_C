                ...
                <div class="panel-body">                    
                    ...
                    <div id="smtp_config" style="<?= ($prot == "smtp" ? ' display:block' : 'display:none') ?>">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" required="" class="form-control"  value="<?= $this->config->item('smtp_host') ?>" name="smtp_host">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" required="" class="form-control"  value="<?= $this->config->item('smtp_user') ?>" name="smtp_user">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="password" required="" class="form-control" value="<?= $this->config->item('smtp_pass'); ?>" name="smtp_pass">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('smtp_port') ?></label>
                            <div class="col-lg-6">
                                <input type="text" required="" class="form-control" value="<?= $this->config->item('smtp_port') ?>" name="smtp_port">
                            </div>
                        </div>
                    </div>                                             
                    <div class="form-group">                    
