<div id="printReport">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <div class="box-title">
                <h4><?= lang('expense_report') ?></h4>        
            </div>
            <div class="pull-right hidden-print">
                <a href="<?php echo base_url() ?>admin/report/expense_report_pdf/" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="<?= lang('pdf') ?>"><?= lang('pdf') ?></a>
        ...
        <div class="box-body">
            ...
            <p><?= lang('total_expense') ?>: <?php
                ...
                echo $curency->symbol . ' ' . number_format($total_expense->debit, 2)
                ?></p>
            <p><?= lang('total_expense_this_month') ?>: <?= $curency->symbol . ' ' . number_format($this_month->debit, 2) ?></p>
            <p><?= lang('total_expense_this_week') ?>: <?= $curency->symbol . ' ' . number_format($this_week->debit, 2) ?></p>
            <p><?= lang('total_expense_last_30') ?>: <?= $curency->symbol . ' ' . number_format($this_30_days->debit, 2) ?></p>        
                ...
                <tbody>
                    ...
                    foreach ($all_deposit_info as $v_deposit) :
                        ...
                        <tr>
                            ...
                            <td><?= $curency->symbol . ' ' . number_format($v_deposit->debit, 2) ?></td>
