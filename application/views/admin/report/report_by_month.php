    ...
    <div class="show_print" style="width: 100%; border-bottom: 2px solid black;">
        <table style="width: 100%; vertical-align: middle;">
            <tr>
                ...
                <td style="width: 50px;">
                    <img style="width: 50px;height: 50px" src="<?= base_url() . config_item('company_logo') ?>" alt="" class="img-circle"/>
                </td>
                <td>
                                ...
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <div class="pull-right hidden-print">                                                                      
                                            ...
                                            <button style="background: none;border: none" class="btn-print" type="button" data-toggle="tooltip" title="Print" onclick="expense_report('expense_report')"><?php echo btn_print(); ?></button>                                                              
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($v_monthly_report)): foreach ($v_monthly_report as $v_month) :
                                                ...
                                                <tr class="custom-tr custom-font-print">
                                                    ...
                                                    <td><?= $curency->symbol . ' ' . number_format($v_month->amount, 2) ?></td>                                                       
                                                    <td><?= $curency->symbol . ' ' . number_format($v_month->credit, 2) ?></td>                                                       
                                                    <td><?= $curency->symbol . ' ' . number_format($v_month->debit, 2) ?></td>                                                       
                                                    <td><?= $curency->symbol . ' ' . number_format($v_month->total_balance, 2) ?></td>      
                                                </tr>
                                                <?php
