<div id="printReport">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <div class="box-title">
                <h4><?= lang('income_report') ?></h4>        
            </div>
            <div class="pull-right hidden-print">
                <a href="<?php echo base_url() ?>admin/report/income_report_pdf/" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="<?= lang('pdf') ?>"><?= lang('pdf') ?></a>
