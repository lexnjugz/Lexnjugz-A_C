...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="<?= base_url() ?>client/mailbox/delete_mail/inbox" >
            <!-- Main content -->                 
            <div class="box box-primary">                    
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        ...
                        <a href="<?= base_url() ?>client/mailbox/index/compose" class="btn btn-danger">Compose +</a>                                
                    </div>
                    <br />
                                        ...
                                        <tr>                                                                                                                                
                                            ...
                                            <td class="mailbox-star">
                                                <?php if ($v_inbox_msg->favourites == 1) { ?>
                                                    <a href="<?= base_url() ?>client/mailbox/index/added_favourites/<?php echo $v_inbox_msg->inbox_id ?>/0"><i class="fa fa-star text-yellow"></i></a>
                                                <?php } else { ?>
                                                    <a href="<?= base_url() ?>client/mailbox/index/added_favourites/<?php echo $v_inbox_msg->inbox_id ?>/1"><i class="fa fa-star-o text-yellow"></i></a>    
                                                <?php } ?>
                                            </td>                                                                                         
                                            <td class="mailbox-name"><a href="<?= base_url() ?>client/mailbox/index/read_inbox_mail/<?php echo $v_inbox_msg->inbox_id ?>"><?php
                                            ...
                                            <td><a class="btn btn-primary btn-xs" href="<?= base_url() ?>client/mailbox/restore/inbox/<?php echo $v_inbox_msg->inbox_id ?>" data-toggle="tooltip" data-placement="top"  title="Restore"><i class="fa fa-retweet"></i></a>                                                
                                                <a class="btn btn-danger btn-xs" href="<?= base_url() ?>client/mailbox/delete_mail/inbox/deleted/<?php echo $v_inbox_msg->inbox_id ?>" onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" data-toggle="tooltip" data-placement="top"  title="Permanent&nbsp;Delete"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>                  
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
