...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="<?= base_url() ?>client/mailbox/delete_mail/sent" >            
                            ...
                            <tbody style="font-size: 13px">
                                <?php if (!empty($get_sent_message)):foreach ($get_sent_message as $v_sent_msg): ?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary btn-xs" href="<?= base_url() ?>client/mailbox/restore/sent/<?php echo $v_sent_msg->sent_id ?>" data-toggle="tooltip" data-placement="top"  title="Restore"><i class="fa fa-retweet"></i></a>                                                
                                                <a class="btn btn-danger btn-xs" href="<?= base_url() ?>client/mailbox/delete_mail/sent/deleted/<?php echo $v_sent_msg->sent_id ?>" onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" data-toggle="tooltip" data-placement="top"  title="Permanent&nbsp;Delete"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>                  
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
