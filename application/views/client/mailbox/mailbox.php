    ...
    <div class="col-md-3">        
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title"><?= lang('all_messages') ?></h3>
                <div class="box-tools">
            ...
            <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="<?php echo ($menu_active == 'draft') ? 'active' : ''; ?>"><a href="<?= base_url() ?>client/mailbox/index/draft"><i class="fa fa-file-text-o"></i> Drafts</a></li>
                    <li class="<?php echo ($menu_active == 'favourites') ? 'active' : ''; ?>">
                        <a href="<?= base_url() ?>client/mailbox/index/favourites"> <i class="fa fa-star text-yellow"></i>
                            <?= lang('favourites') ?>
                        </a>
                    </li>
