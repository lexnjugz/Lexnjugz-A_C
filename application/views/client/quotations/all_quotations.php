                    ...
                    if (!empty($all_quatations)) {
                        foreach ($all_quatations as $v_quatations) {
                            ...
                            <tr>
                                ...
                                ?>
                                <td><a href="<?= base_url() ?>client/quotations/quotations_details/<?= $v_quatations->quotations_id ?>"><?= $v_quatations->quotations_form_title; ?></a></td>                                
                                <td><?= $v_quatations->name . ' ' . $client_status; ?></td>                                
                                <td><?= strftime(config_item('date_format'), strtotime($v_quatations->quotations_date)) ?></td>                               
                                <td><?= $currency->symbol ?> <?= number_format($v_quatations->quotations_amount, 2) ?></td>
                                <td><?php
                                ...
                                if (!empty($value)) {
                                    ...
                                    <?php if ($field_type == 'paragraph'): ?>
                                        ...
                                        <div class="">
                                            ...
                                            ?>
                                            <textarea name="<?php echo $value['cid'] ?>" style="<?= $height ?>" class="form-control"></textarea>
                                        </div> 
                                        <br/>
                                    <?php endif; ?>
                                    <?php if ($field_type == 'dropdown'): ?>
                                        <label class="control-label"><?php echo $value['label'] ?> <?php if (!empty($required)) { ?><span class="text-danger">*</span><?php } ?></label>
                                        <div class="">
                                            <select class="form-control" style="font-size: 13px;" name="<?php echo $value['cid'] ?>">
                                                <?php
                                    ...
                                    <?php if ($field_type == 'checkboxes'): ?>
                                        ...
                                        <div class="">
                                            ...
                                            foreach ($options as $v_option) {
                                                ...
                                                ?>
                                                <input type="checkbox" name="<?php echo $value['cid'] ?>[]" value="<?= $v_option['label'] ?>" style="width: 15px;height: 15px;margin-right: 5px"  <?= $checked ?> ><?= $v_option['label'] ?>
                                            <?php } ?>
                                        </div>                            
                                        <br/>
                                    <?php endif; ?>                            
                                    <?php if ($field_type == 'radio'): ?>
                                        ...
                                        <div class="">
                                            ...
                                            foreach ($options as $v_option) {
                                                ...
                                                ?>
                                                <input name="<?php echo $value['cid'] ?>" type="radio" value="<?= $v_option['label'] ?>" style="width: 15px;height: 15px;margin-right: 5px"  <?= $checked ?> ><?= $v_option['label'] ?>
                                            <?php } ?>
                                        </div>                            
                                        <br/>
                                    <?php endif; ?>                            
