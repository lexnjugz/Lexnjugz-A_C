...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content no-padding">
        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
            <form class="form-horizontal" action="<?= base_url() ?>client//quotations/add_form" method="post" id="addQuotationForm">
                <!-- Sidebar ends -->
                <!-- Main bar -->
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="quotationforms_title" autocomplete="off" placeholder="<?= lang('form_title') ?>">
                    </div>
                </div>
                <!--WI_QUOTATION_TITLE-->
                <div class="row">
