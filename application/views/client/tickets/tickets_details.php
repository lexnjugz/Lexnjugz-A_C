    ...
    <div class="col-sm-3">
        <div class="panel panel-default">
            <div class="panel-heading">      
                <a style="margin-top: -5px" href="<?= base_url() ?>client/tickets/index/edit_tickets" data-original-title="<?= lang('new_ticket') ?>" data-toggle="tooltip" data-placement="top" class="btn btn-icon btn-<?= config_item('button_color') ?> btn-sm pull-right"><i class="fa fa-plus"></i></a>
                <?= lang('all_tickets') ?>
            </div>                        
                            ...
                            <ul class="dropdown-menu">
                                ...
                                if (!empty($status_info)) {
                                    foreach ($status_info as $v_status) {
                                        ?>
                                        <li><a data-toggle='modal' data-target='#myModal' href="<?= base_url() ?>client/tickets/change_status/<?= $tickets_info->tickets_id ?>/<?= $v_status->status ?>"><?= ucfirst($v_status->status) ?></a></li>
                                        <?php
                                    }
                                }
                                ?>
                ...
                <ul class="list-group no-radius">
                    ...
                    <?php if ($tickets_info->filename != NULL) { ?>
                        <li class="list-group-item"><span class="pull-right">
                                <a href="<?= base_url() ?>client/tickets/index/download_file/<?= $tickets_info->tickets_id ?>"><?= lang('download') ?></a></span><?= lang('resourcement') ?></li>
                    <?php } ?>
            ...
            <div  class="col-lg-8">
                ...
                <a class="pull-left  " >
                    <?php if (!empty($profile_info)) { ?>
                        <img style="width: 36px;margin-right: 10px;" src="<?= base_url() . $profile_info->avatar ?>" class="img-circle">
                    <?php } ?> 
                </a>
                <section class="media-body">

                    <section class="panel panel-default">
                        <form method="post" action="<?= base_url() ?>client/tickets/index/save_reply/<?= $v_tickets_info->tickets_id ?>">
