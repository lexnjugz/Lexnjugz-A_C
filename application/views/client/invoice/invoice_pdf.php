            ...
            <table style="width: 100%; vertical-align: middle;">
                <tr>
                    ...
                    <td style="border: 0px;float: right;">
                        <small style="float: right;"><?= $language_info['invoice_date'] ?> : <?= strftime(config_item('date_format'), strtotime($invoice_info->date_saved)); ?></small>
                    </td>                    
                </tr>
            </table>
        </div>
                ...
                <tbody>
                    <tr style="width: 100%;">
                        ...
                        <td>
                            ...
                            <p></p>            
                            <p><b><?= $language_info['payment_due'] ?> :</b> <?= strftime(config_item('date_format'), strtotime($invoice_info->due_date)); ?></p>
                            <?php
                    ...
                    <td colspan="2">
                        <table class="table1" style="width: 100%;border:0px">
                            <tr >
                                ...
                                <td style="border:0px"> <?= number_format($this->invoice_model->calculate_to('invoice_cost', $invoice_info->invoices_id), 2) ?></td>
                            </tr>
