                                ...
                                <div style="padding:35px;">
                                    ...
                                    <div style="width: 70%;float: left;">
                                        <div style="width: 100%;padding: 11px 0;">
                                            ...
                                            <div style="width:65%;border-bottom:1px solid #eee;float:right;foat:right;"><?= $cur ?> <?= number_format($client_payable, 2) ?></div>
                                            <div style="clear:both;"></div>
                                        </div><div style="width: 100%;padding: 10px 0;">
                                            <div style="color:#999;width:35%;float:left;"><?= lang('payments_sent') ?></div>
                                            <div style="width:65%;border-bottom:1px solid #eee;float:right;foat:right;min-height:22px"><?= $cur ?> <?= number_format($client_payments, 2) ?></div>
                                            <div style="clear:both;"></div>
                                        </div>
                                    </div>
                                    <div style="text-align:center;color:white;float:right;background:#FC8174;width: 25%;
                                        ...
                                        <span style="font-size:16pt;"><?= $cur ?> <?= number_format($client_payments, 2) ?></span>
                                    ...
                                    <div style="padding-top:25px">
                                        <div style="width:75%;border-bottom:1px solid #eee;float:right"><?= $cur ?> <?= number_format($client_outstanding, 2) ?></div>
