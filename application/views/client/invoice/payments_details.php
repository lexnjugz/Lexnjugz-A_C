                                    ...
                                    <li class="<?= ($v_payments_info->payments_id == $this->uri->segment(5) ? 'active' : '') ?>">
                                        <a href="<?= base_url() ?>client/invoice/manage_invoice/payments_details/<?= $v_payments_info->payments_id ?>">
                                            ...
                                            <div class="pull-right">                                            
                                                <?= $v_payments_info->currency ?> <?= number_format($v_payments_info->amount, 2) ?>
                                            </div> <br>
                            ...
                            <div style="font-size:10pt;">
                                ...
                                <div style="padding:35px;">
                                    ...
                                    <div style="text-align:center;color:white;float:right;background:#1B9BA0;width: 25%;
                                        ...
                                        <span style="font-size:16pt;"><?= $payments_info->currency ?> <?= number_format($payments_info->amount, 2) ?></span>
                                    </div><div style="clear:both;"></div>

                                    <div style="padding-top:10px">
                                        <div style="width:75%;border-bottom:1px solid #eee;float:right"><strong><a href="<?= base_url() ?>#<?= $payments_info->paid_by ?>"><?= ucfirst($client_info->name) ?></a></strong></div>
                                        ...
                                        <table style="width:100%;margin-bottom:35px;table-layout:fixed;" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tbody>
                                                <tr style="border-bottom:1px solid #ededed">
                                                    ...
                                                    <td style="padding: 10px 10px 5px 10px;text-align:right;word-wrap: break-word;" valign="top">
                                                        <span><?= $payments_info->currency ?>  <?= number_format($this->invoice_model->get_invoice_cost($payments_info->invoices_id), 2) ?> (- <?= lang('tax') ?>) </span>
                                                    </td>
                                                    <td style="text-align:right;padding: 10px 10px 10px 5px;word-wrap: break-word;" valign="top">
                                                        <span><?= $payments_info->currency ?>  <?= number_format($payments_info->amount, 2) ?></span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
