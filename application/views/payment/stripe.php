<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <h4 class="modal-title">Paying <strong><?= $invoice_info['currency'] ?> <?= number_format($invoice_info['amount'], 2) ?></strong> for Invoice #<?= $invoice_info['item_name'] ?> <?= lang('via_stripe') ?></h4>
    </div>  
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <input type="text" size="20" class="form-control card-number input-medium" autocomplete="off" placeholder="78965464641654">
            </div>
        </div>
