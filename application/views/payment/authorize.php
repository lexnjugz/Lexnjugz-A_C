...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <h4 class="modal-title">Paying <strong><?=
                $cur->symbol
                ?> <?= number_format($invoice_info['amount'], 2) ?></strong> for Invoice # <?= $invoice_info['item_name'] ?> via Authorize.net</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <input type="text" name="ccn" id="ccNo" size="20" class="form-control card-number input-medium" autocomplete="off" placeholder="10111042254564" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input type="text" id="cvv" name="CSV" size="4" class="form-control card-cvc input-mini" autocomplete="off" placeholder="325" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input type="text" size="2" name="crMonth" id="expMonth" class="form-control input-mini" autocomplete="off" placeholder="MM" required>

            </div>
            <div class="col-lg-2">
                <input type="text" size="4" name="crYear" id="expYear" class="form-control input-mini" placeholder="YYYY" required>
            </div>
        </div>
